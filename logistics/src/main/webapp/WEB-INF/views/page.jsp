...
<!--           </li> -->
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
              <a class="dropdown-item" href="portfolio-1-col.html">Non-Reporting Facilities Report</a>
              <a class="dropdown-item" href="portfolio-2-col.html">CYP - Report</a>
              <a class="dropdown-item" href="portfolio-3-col.html">Supply Status Report</a>
