		...
		<fieldset class="form-group">
			<div class="row">
				...
				<div class="custom-control custom-radio">
					<sf:input type="radio" path="category" class="custom-control-input" checked=true
				...
				<div class="custom-control custom-radio mb-3">
					<sf:input path="category type="radio" class="custom-control-input"
			...
			<div class="row ">
				...
				<legend class="col-form-label col-sm-4 pt-0"> Date From </legend>
					<input type="text" class="form-control datepicker" id="dateFrom" style="width: 300px;" />
				</div>
				<div class="col-sm-4">
			...
			<div class="row form-group" style="margin-top:5px;">
				...
				<div class="col-sm-4 pull-right">
					<input type="button" type="submit" class="btn btn-primary form-control" value="View Report" />
				</div>
